// Se pueden dividir las validaciones de cada campo en funciones individuales para mejorar modularidad.
...
function validate_update(){
    ...
    if (puntos.value == '' || isNaN(puntos.value) || !Number.isInteger(Number(puntos.value)) || Number(puntos.value) < 0) {
        error.innerHTML = 'Se debe ingresar un número entero positivo (0 si no se quieren añadir puntos)';
        div.classList.add("is-invalid");
        state = false;
    } 
